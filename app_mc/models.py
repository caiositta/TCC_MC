...
class Despesas(models.Model):
    ...
    mes = models.ForeignKey("Fechamentos", on_delete=models.CASCADE, related_name='fechamentoDespesas',help_text="deixar automatico")
...
class Faturamentos(models.Model):
    ...
    mes = models.ForeignKey("Fechamentos", on_delete=models.CASCADE, related_name='fechamentoFaturamentos', help_text="deixar automatico")
...
class Fechamentos(models.Model):
    ...
    faturamento = models.DecimalField(null=True, max_digits=12, decimal_places=2)
    despesas = models.DecimalField(null=True, max_digits=12, decimal_places=2)
    balanco = models.DecimalField(null=True, max_digits=12, decimal_places=2)
